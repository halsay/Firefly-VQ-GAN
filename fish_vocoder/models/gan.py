...
class GANModel(VocoderModel):
    ...
    def training_generator(self, audio, audio_mask):
        ...
        loss_gen_all = vq_loss + loss_stft * 2.5 + loss_mel * 45 + loss_adv_all
    ...
    def training_step(self, batch, batch_idx):
        ...
        #     )
        self.log(
            f"train/discriminator/loss_disc_all",
            loss_disc_all,
            on_step=True,
            on_epoch=False,
            prog_bar=False,
    ...
    def forward(self, audio, mask=None, input_spec=None):
        ...
        fake_audio, vq_result = self.generator(input_spec)

        return fake_audio, vq_result
    ...
    def validation_step(self, batch: Any, batch_idx: int):
        ...
        # Generator
        fake_audio, vq_result = self.forward(audio, audio_mask)
        assert fake_audio.shape == audio.shape
